...
import { CTA_LABEL, QUIZ_LINK, company, hero } from './content';
        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,44%)] md:grid-rows-[auto_auto] md:items-center md:gap-x-14 md:gap-y-8">
          ...
          >
            ...
            <motion.h1
              ...
              variants={itemVariants}
            >
              <span className="hero-title-highlight">Küchenplaner / Küchenberater</span>{' '}
              <span className="font-normal text-text">in Voll- oder Teilzeit (m/w/d)</span>
            </motion.h1>
          ...
          >
            <ImageWithFallback
              ...
              fallbackClassName="aspect-[16/10] bg-[linear-gradient(140deg,var(--primary),color-mix(in_srgb,var(--accent)_70%,var(--primary)))] text-[15px] tracking-[0.2em] text-white/70 md:aspect-[4/3]"
            />
          </motion.div>
